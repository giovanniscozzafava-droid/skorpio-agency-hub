...
export const FEATURES: Feature[] = [
  ...
  {
    id: 'rischedula-kanban',
    icon: '🔄',
    title: 'Rischedula dal Kanban',
    description: 'Clicca qualsiasi badge countdown (SCADUTO, URGENTE, IN SCADENZA, SCADE TRA) sulla card → scegli nuova data e ora → il task, il calendario e il CLP si aggiornano in automatico.',
    color: '#3B82F6',
    version: '2026-04-10',
  },
  {
    id: 'rischedula-bidirezionale',
    icon: '📅',
    title: 'Rischedula bidirezionale',
    description: 'Sposta un evento nel calendario → tutti i task collegati si rischedulano. Rischedula un task dal Kanban → il calendario si aggiorna. Tutto sincronizzato.',
    color: '#8B5CF6',
    version: '2026-04-10',
  },
  {
    id: 'brief-completo',
    icon: '🎬',
    title: 'Brief montaggio completo',
    description: 'Il pannello task ora mostra il brief completo: link ispirazione (cliccabile), hook, POV, script, istruzioni montaggio, CTA, musica, hashtag e note. Tutto dal CLP collegato.',
    color: '#6D28D9',
    version: '2026-04-10',
  },
  {
    id: 'counter-dropdown',
    icon: '📊',
    title: 'Contatori cliccabili',
    description: 'Clicca i contatori CLP, Task, Urgenti o Scaduti nella barra → si apre un dropdown con la lista. Da li puoi rischedulare, archiviare o andare al task.',
    color: '#F59E0B',
    version: '2026-04-10',
  },
  {
    id: 'daily-priority-manager',
    icon: '🔀',
    title: 'Daily Priority per tutti',
    description: 'Admin e Elisa vedono i task di TUTTO il team nel Daily Priority. Tab per persona, bottone 🔀 per riassegnare un task a un altro membro con un click.',
    color: '#6C5CE7',
    version: '2026-04-10',
  },
  {
    id: 'monitor-palinsesto',
    icon: '🖥️',
    title: 'Palinsesto Monitor',
    description: 'Nuovo tab Monitor! Gestisci i contenuti dei monitor pubblicitari nei centri estetici. Carica da Drive, crea fasce orarie, programma la rotazione. La TV apre /tv/slug e mostra tutto in fullscreen.',
    color: '#22C55E',
    version: '2026-04-10',
  },
  {
    id: 'nuovi-tab-wip',
    icon: '🚀',
    title: 'Nuove sezioni in arrivo',
    description: 'Aggiunti i tab Siti Web, Andromeda CRM e Report Social. Sono in fase di sviluppo — SKORPIO diventa il centro di comando marketing!',
    color: '#0EA5E9',
    version: '2026-04-10',
  },
];
